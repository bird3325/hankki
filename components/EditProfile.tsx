                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full bg-gray-50 border rounded-2xl pl-12 pr-4 py-4 focus:outline-none focus:ring-1 transition-all ${confirmPassword && newPassword !== confirmPassword
